...
public class PathfinderGoalTempt extends PathfinderGoal {
    ...
    public PathfinderGoalTempt(LivestockLock plugin, EntityCreature paramEntityCreature, float paramFloat, int paramInt, boolean paramBoolean) {
        this.plugin = plugin;
    ...
    public boolean a()
    {
        ...
        OwnedAnimal oa = plugin.getOwnedAnimal(this.a.uniqueID);
        if (!oa.allowAccess(this.h.getName())) {
            this.h = null;
        }
        if (this.h == null) return false;
        ItemStack localItemStack = this.h.cd();
